...
const dotPatterns = {
  light: {
    ...
    hover: `url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32' width='16' height='16' fill='none'%3E%3Ccircle fill='%2300c97f' id='pattern-circle' cx='10' cy='10' r='2.5'%3E%3C/circle%3E%3C/svg%3E")`,
  },
  dark: {
      ...
      <motion.div
        ...
        style={{
          ...
          WebkitMaskImage: useMotionTemplate`
            radial-gradient(
              ${highlightRadius} circle at ${mouseX}px ${mouseY}px,
              black 0%,
              transparent 100%
            )
          `,
